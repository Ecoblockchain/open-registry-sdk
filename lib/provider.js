...
Provider.prototype.getRegistry = function (addr) {
  return this.web3.eth.contract(registryAbi).at(addr);
}

Provider.prototype.getRegistrar = function (addr) {
  return this.web3.eth.contract(registrarAbi).at(addr);
}
